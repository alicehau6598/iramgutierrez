                    ...
                    <div class="hs-inner">
                        ...
                        <div class="portfolio">
                            ...
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/1-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
                                    ...
                                    <div class="mfp-hide mfp-with-anim work_desc work1">
                                        <div class="col-md-6">
                                            <div class="image_work">
                                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/b2b.jpg" alt="img" width="560">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <!-- Portfolio Item -->
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/2-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
                            ...
                            <!-- Portfolio Item -->
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/3-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
                            ...
                            <!-- Portfolio Item -->
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/4-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
                                    <span class="label">web design</span>
                                    <div class="portfolio_button">
                                        <h3>Project Title</h3>
                            ...
                            <!-- Portfolio Item -->
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/5-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
                                    <span class="label">Mobile app</span>
                                    <div class="portfolio_button">
                                        <h3>Project Title</h3>
                            ...
                            <!-- Portfolio Item -->
                            <figure class="effect-milo">
                                <img src="<?php bloginfo('template_directory')?>/images/portfolio/6-thumb.jpg" alt="img11" width="282" height="222" />
                                <figcaption>
