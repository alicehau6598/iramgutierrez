jQuery(document).ready(function($) {
    ...
    var latitude = $("#cd-google-map").data("latitude"),
        longitude = $("#cd-google-map").data("longitude"),
        map_zoom = 14;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'wp-content/themes/tyrone/images/gmaps/cd-icon-location.png' : 'wp-content/themes/tyrone/images/gmaps/cd-icon-location.svg';
